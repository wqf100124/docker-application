import{_ as s,c as n,o as a,a as l}from"./app.7530d465.js";const d=JSON.parse('{"title":"Jenkins","description":"","frontmatter":{},"headers":[],"relativePath":"deploy/jenkins.md"}'),p={name:"deploy/jenkins.md"},e=l(`<h1 id="jenkins" tabindex="-1">Jenkins <a class="header-anchor" href="#jenkins" aria-hidden="true">#</a></h1><p>\u5B89\u88C5</p><p>\u5185\u5B58\u5C0F\uFF0C\u4E0D\u8981\u88C5</p><div class="language-sh"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">docker run -p 8080:8080 -p 50000:50000 jenkins/jenkins:lts-jdk11</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"></span></code></pre></div>`,10),o=[e];function c(t,i,r,A,y,C){return a(),n("div",null,o)}var _=s(p,[["render",c]]);export{d as __pageData,_ as default};
